...
import {
  Configuration,
  ParserConfiguration,
} from '@mathjax/src/mjs/input/tex/Configuration.js';
...
import {
  CharacterMap,
  CommandMap,
} from '@mathjax/src/mjs/input/tex/TokenMap.js';
...
function angleChars(parser: TexParser, mchar: TexToken) {
  ...
  const msupNode = parser.create('node', 'msup', [
    emptyToken,
    symbolToken,
  ]);
...
export const configuration = Configuration.create('siunitx', {
  handler: {
